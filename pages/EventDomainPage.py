class EventDomainPage:
    def __init__(self, page):
        self.page = page
        
    def create_EventDomain(self):
        ...
        # self.page.fill("input[name='name']", "Campus Programs")
        ...
        # self.page.locator('a.edit[data-id="2"]').click()
        # self.page.wait_for_timeout(4000)
        
        # self.page.locator('#editModal input[id="edit_name"]').clear()
        # self.page.wait_for_timeout(3000)
        
        # self.page.locator('#editModal input[id="edit_name"]').fill("Creative Events")
        # self.page.wait_for_timeout(3000)
    ...
    # active country
        ...
        self.page.fill("//input[@name='search']",("Creative Events"))
        self.page.wait_for_timeout(6000)
